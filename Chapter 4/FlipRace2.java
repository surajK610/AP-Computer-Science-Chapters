   ...
   public static void main (String[] args)
   {
      ...
      Coin coin3 = new Coin ();
          ...
          while (count1 < GOAL && count2 < GOAL && count3 < GOAL)
          {
             ...
             if (coin1.isHeads() && count1 < 2)
                count1++;
             else if ( coin1.isTails() && count1 >= 2 )
                count1 ++;
             else 
                count1 = 0;
             if (coin2.isHeads() && count2 < 2)
                count2++;
             else if ( coin2.isTails() && count2 >= 2 )
                count2 ++;
             else 
                count2 = 0;
             if (coin3.isHeads() && count3 < 2)
                count3++;
             else if ( coin3.isTails() && count3 >= 2 )
                count3 ++;
             else 
                count3 = 0;
