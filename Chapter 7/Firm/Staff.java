...
public class Staff
{
   ...
   public Staff ()
   {
      ...
      staffList[5] = new Volunteer ("Carla", "321 Duds Lane",
         "555-7282");
      staffList[6] = new Commissioner ("Dr. Mack", "678 Ninth Ave.",
         "555-0691", "958-47-3626", 6.25, .2);
      staffList[7] = new Commissioner ("Dr. Doc", "4758 Tenth Ave.",
         "555-6969", "958-47-4200", 9.75, .15);
         
      ((Executive)staffList[0]).awardBonus (500.00);

      ((Hourly)staffList[3]).addHours (40);
      
      ((Commissioner)staffList[6]).addHours (35);
      ((Commissioner)staffList[6]).addSales (400);
      
      ((Commissioner)staffList[7]).addHours (40);
      ((Commissioner)staffList[7]).addSales (950);
   }
